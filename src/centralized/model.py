...
class HeartDiseaseModel(Model):
    def __init__(self, input_dim: int):
        ...
        # block 2 + residual projection defined HERE (not inside call)
        ...
        self.res_proj = layers.Dense(128, activation=None)  # <- moved out of call
    ...
    def call(self, inputs, training=False):
        ...
        h2 = h2 + self.res_proj(h1)  # safe: layer created in __init__
